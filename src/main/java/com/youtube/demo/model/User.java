...
public class User extends ParentEntity {
	...
	public String getSecondSurmame() {
		return secondSurmame;
	}
	public void setSecondSurmame(String secondSurmame) {
		this.secondSurmame = secondSurmame;
	}
